...
# Bloc de localisation utilisant les données Google Sheets
with st.expander("📍 Lieu et Locataire", expanded=True):
    ...
    with col1:
        ...
        if mode_lieu == "Logement" and len(residences) == 1:
            ...
            # Filtrage dynamique depuis le DataFrame Sheets
...
# --- 5. LOGIQUE D'ANALYSE IA (GEMINI 3) ---
...
if lancer_analyse:
    if source_photo or notes:
        with st.spinner("Analyse technique par Gemini 3..."):
            try:
                # Utilisation de la version qui a fonctionné sur ta vidéo
                ...
                CONSIGNES :
                1. Identifie le problème technique.
                2. Si c'est un défaut d'entretien (moisissures, joints sales), ajoute obligatoirement : '{phrase_locatif}'.
                3. Propose une solution d'entretien ou réparation.
                """
...
constat_final = st.text_area("Résultat :", value=resultat_ia, height=300)
