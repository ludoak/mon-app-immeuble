        ...
        if not photo:
            ...
            with st.spinner("Analyse par gemini-3-flash-preview..."):
                try:
                    ...
                    # Paramètres de sécurité pour éviter le blocage "Safety" (finish_reason 1)
...
L'équipe technique GH."""
                        ...
                        st.error("L'IA a bloqué l'analyse pour des raisons de sécurité. Essayez une photo plus cadrée sur le problème technique.")
